...
struct	pentry	{
	...
	int	pwaitret;
	int counter;       /* preempt for LINUXSCHED */
	int basepriority;    /* record the priority when a new epoch start, used for LINUXSCHED */
	int goodness;      /* priority measure for LINUXSCHED */
};
